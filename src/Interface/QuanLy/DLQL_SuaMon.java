 ...
 * @author Admin
 */
public class DLQL_SuaMon extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(19, 19, 19)
                .addComponent(btnXacNhan, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        try {
            ...
            if (cbxLoaiMon.getItemCount() == 0) {
                JOptionPane.showMessageDialog(null, "Chưa chọn loại món không được để trống !");
                return;
            }
            if (!txtTenMon.getText().trim().matches(regexVietnamese)) {
                JOptionPane.showMessageDialog(null, "Tên món không được chứa kí tự đặc biệt hoặc số");
                return;
            }
            if (!txtDVT.getText().trim().matches(regexVietnamese)) {
                JOptionPane.showMessageDialog(null, "Đơn vị tính không được chứa kí tự đặc biệt hoặc số");
                return;
            }
            MonAnDTO td = new MonAnDTO();
            td.setMaMon(StoreData.currentMonAn.getMaMon());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DLQL_SuaMon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DLQL_SuaMon dialog = new DLQL_SuaMon();
