 ...
 * @author Admin
 */
public class DLQL_SuaBan extends javax.swing.JDialog {

    ConnectSQL con = new ConnectSQL();

    /**
     * Creates new form DLQL_SuaBan
     */
    public DLQL_SuaBan() {
        initComponents();
        txtTenBan.setText(StoreData.currentBan.GetTenBan());
    }
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, ex.getMessage(), "Update Failed", JOptionPane.WARNING_MESSAGE);
        }
...
//            java.util.logging.Logger.getLogger(DLQL_SuaBan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                DLQL_SuaBan dialog = new DLQL_SuaBan(new javax.swing.JFrame(), true, );
